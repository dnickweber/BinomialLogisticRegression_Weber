...
pairs(Mortality ~ Fight.Time..min. + Handling.Time..min. + Hook.Location + Fork.Length..cm. + Condition + pH + Lactate..mmol.L. + Water.Temp, data=blacktip_raw, na.action=na.omit, panel=panel.smooth)
